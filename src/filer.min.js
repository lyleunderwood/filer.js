...
var Filer=new function(){function a(e){if(b=e||null)c=b.root,d=!0}var b=null,c=null,d=!1,i=function(e){return 0==e.indexOf("filesystem:")},l=function(e){i(e)||(e="/"==e[0]?b.root.toURL()+e.substring(1):0==e.indexOf("./")||0==e.indexOf("../")?"../"==e&&c!=b.root?c.toURL()+"/"+e:c.toURL()+e:c.toURL()+"/"+e);return e},m=function(e,a){var b=arguments[1],f=arguments[2],c=function(e){if(e.code==FileError.NOT_FOUND_ERR){if(f)throw Error('"'+b+'" or "'+f+'" does not exist.');throw Error('"'+b+'" does not exist.');
}throw Error("Problem getting Entry for one or more paths.");},j=l(b);if(3==arguments.length){var d=l(f);self.resolveLocalFileSystemURL(j,function(a){self.resolveLocalFileSystemURL(d,function(b){e(a,b)},c)},c)}else self.resolveLocalFileSystemURL(j,e,c)},p=function(e,a,c,f,g,j){if(!b)throw Error("Filesystem has not been initialized.");if(typeof e!=typeof a)throw Error("These method arguments are not supported.");var d=c||null,n=void 0!=j?j:!1;(e.isFile||a.isDirectory)&&a.isDirectory?n?e.moveTo(a,d,
...
var a=a?a:{},f=a.size||1048576;this.type=self.TEMPORARY;if("persistent"in a&&a.persistent)this.type=self.PERSISTENT;var g=function(a){this.size=f;b=a;c=b.root;d=!0;k&&k(a)};this.type==self.PERSISTENT&&self.storageInfo?self.storageInfo.requestQuota(this.type,f,function(a){self.requestFileSystem(this.type,a,g.bind(this),h)}.bind(this),h):self.requestFileSystem(this.type,f,g.bind(this),h)};a.prototype.ls=function(a,k,d){if(!b)throw Error("Filesystem has not been initialized.");var f=function(a){var e=
[],b=a.createReader(),c=function(){b.readEntries(function(a){a.length?(e=e.concat(Util.toArray(a)),c()):(e.sort(function(a,e){return a.name<e.name?-1:e.name<a.name?1:0}),k(e))},d)};c()};a.isDirectory?f(a):i(a)?m(f,l(a)):c.getDirectory(a,{},f,d)};a.prototype.mkdir=function(a,k,d,f){if(!b)throw Error("Filesystem has not been initialized.");var g=null!=k?k:!1,j=a.split("/"),o=function(b,c){if("."==c[0]||""==c[0])c=c.slice(1);b.getDirectory(c[0],{create:!0,exclusive:g},function(b){if(b.isDirectory)c.length&&
